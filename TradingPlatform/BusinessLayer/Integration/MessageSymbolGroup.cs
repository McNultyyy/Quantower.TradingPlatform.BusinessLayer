...
// Type: TradingPlatform.BusinessLayer.Integration.MessageSymbolGroup
...
public class MessageSymbolGroup : Message
{
  public override MessageType Type => MessageType.SymbolGroup;
  ...
  public override string ToString()
  {
    ...
    interpolatedStringHandler.AppendFormatted(this.GroupName);
