...
// Type: TradingPlatform.BusinessLayer.HistoryAggregationPriceChangesCountBars
...
public sealed class HistoryAggregationPriceChangesCountBars : 
  HistoryAggregation,
  IHistoryAggregationHistoryTypeSupport
{
  private const string 퓥픘 = "Ticks count";

  public override string Name => \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픣픃();

  public int PriceChangesCount { get; [param: In] private set; }
  ...
  public override IList<SettingItem> Settings
  {
    get
    {
      ...
      SettingItemInteger settingItemInteger = new SettingItemInteger(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픣핃(), this.PriceChangesCount);
    ...
    set
    {
      ...
      foreach (SettingItem settingItem in (IEnumerable<SettingItem>) value)
      {
        ...
        if (!(name == \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픣핃()))
        {
          ...
          this.PriceChangesCount = (int) settingItem.Value;
      }
    }
  }
  ...
  {
    this.PriceChangesCount = priceChangesCount;
    this.HistoryType = historyType;
  }

  public HistoryAggregationPriceChangesCountBars(
    HistoryAggregationPriceChangesCountBars aggregation)
    : base((HistoryAggregation) aggregation)
  {
    this.PriceChangesCount = aggregation.PriceChangesCount;
  ...
  public override string ToString()
  {
    ...
    interpolatedStringHandler.AppendFormatted<int>(this.PriceChangesCount);
  ...
  {
    return dt.ToString(DateTimeFormatInfo.CurrentInfo.ShortDatePattern + \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.핇프() + (this.PriceChangesCount > 1 ? \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픣피() : \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픣퓎()));
  }

  [NotPublished]
  public override object Clone() => (object) new HistoryAggregationPriceChangesCountBars(this);
