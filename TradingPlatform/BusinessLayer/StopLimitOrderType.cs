...
// Type: TradingPlatform.BusinessLayer.StopLimitOrderType
...
public class StopLimitOrderType(params TimeInForce[] allowedTimeInForce) : LimitOrderType(allowedTimeInForce)
{
  public override string Id => \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픁퓜();

  public override string Name
  {
    get => loc.key(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픎픹());
  }

  public override string Abbreviation
  {
    get => \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픎퓺();
  }
    ...
    FormatSettings formatSettings)
  {
    ...
    if (symbol != null)
    {
      ...
      {
        price2 = CoreMath.ProcessNaN(parameters.Side == Side.Buy ? symbol.Ask : symbol.Bid);
        price1 = symbol.CalculatePrice(price2, parameters.Side == Side.Buy ? -1.0 : 1.0);
      }
      else if (parameters.Type == RequestType.ModifyOrder)
      {
        price1 = parameters.Price;
        price2 = parameters.TriggerPrice;
      ...
      VariableTick variableTick1 = symbol.FindVariableTick(price1);
      if (variableTick1 != null)
        num1 = variableTick1.TickSize;
      VariableTick variableTick2 = symbol.FindVariableTick(price2);
      if (variableTick2 != null)
      {
        num2 = variableTick2.TickSize;
        num3 = variableTick2.Precision;
      }
    }
    SettingItemDouble settingItemDouble = new SettingItemDouble(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픇퓜(), price2);
    settingItemDouble.Text = loc._(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.퓗핀(), callerFilePath: \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픎픊());
  ...
  public override void SetDefaultPrices(SettingItem[] settings, OrderRequestParameters parameters)
  {
    ...
    if (double.IsNaN(num))
      return;
    double price = parameters.Symbol.CalculatePrice(num, parameters.Side == Side.Buy ? -1.0 : 1.0);
    ((IEnumerable<SettingItem>) settings).UpdateItemValue(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픇퓜(), (object) num);
    ((IEnumerable<SettingItem>) settings).UpdateItemValue(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.퓍핈(), (object) price);
  }
}
