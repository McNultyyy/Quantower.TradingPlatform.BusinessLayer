...
// Type: TradingPlatform.BusinessLayer.HistoryAggregationTimeStatistics
...
{
  public override string Name => \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.퓙픾();
  ...
  public HistoryAggregationTimeStatistics(Period period) => this.Period = period;
  ...
  [NotPublished]
  public override object Clone() => (object) new HistoryAggregationTimeStatistics(this);
  ...
  public override HistoryAggregation GetAggregationToDirectDownload(HistoryMetadata metadata)
  {
    ...
    {
      BasePeriod[] aggregationTimeStatistics = metadata.AllowedBasePeriodsHistoryAggregationTimeStatistics;
      period = this.Period;
      int basePeriod = (int) period.BasePeriod;
      if (((IEnumerable<BasePeriod>) aggregationTimeStatistics).Contains<BasePeriod>((BasePeriod) basePeriod) || ((IEnumerable<Period>) metadata.AllowedPeriodsHistoryAggregationTimeStatistics).Contains<Period>(this.Period))
        return (HistoryAggregation) this;
    }
    if (((IEnumerable<string>) metadata.AllowedAggregations).Contains<string>(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.퓙퓍()))
    {
      BasePeriod[] aggregationTimeStatistics = metadata.AllowedBasePeriodsHistoryAggregationTimeStatistics;
      period = this.Period;
      int basePeriod = (int) period.BasePeriod;
      if (((IEnumerable<BasePeriod>) aggregationTimeStatistics).Contains<BasePeriod>((BasePeriod) basePeriod) || ((IEnumerable<Period>) metadata.AllowedPeriodsHistoryAggregationTimeStatistics).Contains<Period>(this.Period))
        return (HistoryAggregation) new HistoryAggregationVolumeProfile(this.Period);
    }
