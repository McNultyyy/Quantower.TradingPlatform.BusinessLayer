...
// Type: TradingPlatform.BusinessLayer.Settings.Condition.OperandCustomSymbol
...
public sealed class OperandCustomSymbol : ConditionOperandBase
{
  public override string Name => \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.퓗픯();

  public override ConditionOperandBaseType ValueType => ConditionOperandBaseType.Symbol;
  ...
  public OperandCustomSymbol(OperandCustomSymbol operandCustomDate)
  {
  ...
  public override void FromXElement(XElement element, DeserializationInfo deserializationInfo)
  {
    ...
    if ((BusinessObjectInfo) empty == BusinessObjectInfo.Empty || empty == SymbolInfo.Empty)
      return;
    this.Value = Core.Instance.GetSymbol((BusinessObjectInfo) empty);
  }
  ...
  public override object Clone() => (object) new OperandCustomSymbol(this);
}
