...
{
  public static HistoryProcessorEventArgs Empty => new HistoryProcessorEventArgs();

  public UpdateReason IndicatorUpdateReason { get; [param: In] private set; }

  public HistoryProcessorEventArgs(UpdateReason updateReason = UpdateReason.Unknown)
  {
    this.IndicatorUpdateReason = updateReason;
  }
}
