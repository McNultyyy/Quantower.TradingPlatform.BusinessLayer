...
// Type: TradingPlatform.BusinessLayer.HistoryAggregationPowerTrades
...
{
  public override string Name => \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.퓲퓐();

  public HistoryAggregationPowerTradesParameters Parameters { get; }

  public HistoryAggregationPowerTrades()
  {
    this.Parameters = new HistoryAggregationPowerTradesParameters();
  }
  ...
  {
    this.Parameters = aggregation.Parameters?.Clone() as HistoryAggregationPowerTradesParameters;
  }
  ...
  [NotPublished]
  public override object Clone() => (object) new HistoryAggregationPowerTrades(this);
