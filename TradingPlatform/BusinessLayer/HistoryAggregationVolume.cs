...
// Type: TradingPlatform.BusinessLayer.HistoryAggregationVolume
...
public sealed class HistoryAggregationVolume : HistoryAggregation
{
  ...
  public override string Name => \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.피();

  public int VolumeValue { get; [param: In] private set; }
  ...
  public override IList<SettingItem> Settings
  {
    get
    {
      ...
      SettingItemInteger settingItemInteger = new SettingItemInteger(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.퓙픁(), this.VolumeValue);
    ...
    set
    {
      ...
      {
        if (settingItem.Name == \u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.퓙픁())
          this.VolumeValue = (int) settingItem.Value;
      }
    }
  }

  public HistoryAggregationVolume(int volumeValue) => this.VolumeValue = volumeValue;
  ...
  public override string ToString()
  {
    ...
    interpolatedStringHandler.AppendFormatted<int>(this.VolumeValue);
    interpolatedStringHandler.AppendLiteral(\u00307C3E6A3\u002DEEDE\u002D4239\u002DAF49\u002D17D6CE9EDE09.픣핈());
    return interpolatedStringHandler.ToStringAndClear();
  }

  private HistoryAggregationVolume([In] HistoryAggregationVolume obj0)
    : base((HistoryAggregation) obj0)
  {
    this.VolumeValue = obj0.VolumeValue;
  }

  [NotPublished]
  public override object Clone() => (object) new HistoryAggregationVolume(this);
